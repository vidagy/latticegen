...
namespace Geometry
{
  ...
  std::tuple<size_t, size_t, size_t> CutoffCube::steps_to_cover(const UnitCell3D& unit_cell) const
  {
  ...
  std::tuple<size_t, size_t, size_t> CutoffSphere::steps_to_cover(const UnitCell3D& unit_cell) const
  {
    return std::make_tuple(
  ...
  std::tuple<size_t, size_t, size_t> CutoffUnitVectors::steps_to_cover(const UnitCell3D& unit_cell) const
  {
